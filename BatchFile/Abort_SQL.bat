...
copy /V /Y "C:\Automation\SinglePoint\AddressBase\WebSite\Abort_File\Abort_SQL.xls" "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\Run_Completion_SQL\"
...
md "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\CSVReport_Recipient\SQL\SERVICE_LOG\Service_LOG%Pdate%%Currtime%\"

copy /V /Y "C:\Automation\BL_iEx\ServiceOperation\SaveEventLogfile\ServiceLog.csv" "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\CSVReport_Recipient\SQL\SERVICE_LOG\Service_LOG%Pdate%%Currtime%\"

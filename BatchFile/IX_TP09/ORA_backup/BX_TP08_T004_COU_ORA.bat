...
md "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\TestResults\BX_TP08\ORACLE\T004\ImportReport\IR_%Pdate%%Currtime%\"

copy /V /Y "C:\Automation\BL_iEx\CSV\Import Files\COU_Report\ORACLE\*.*" "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\TestResults\BX_TP08\ORACLE\T004\ImportReport\IR_%Pdate%%Currtime%\"
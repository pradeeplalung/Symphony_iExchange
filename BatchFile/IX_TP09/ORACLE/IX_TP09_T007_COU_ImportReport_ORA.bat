...
md "R:\Symphony iExchange\Testing\Automation\iManage\LLPG\TestResults\IX_TP09\ORACLE\T006\ImportReport\IR_%Pdate%%Currtime%\"

copy /V /Y "C:\Automation\BL_iEx\CSV\Import Files\LO_Report\ORACLE\*.*" "R:\Symphony iExchange\Testing\Automation\iManage\LLPG\TestResults\IX_TP09\ORACLE\T006\ImportReport\IR_%Pdate%%Currtime%\"
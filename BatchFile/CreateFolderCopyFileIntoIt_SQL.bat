...
md "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\CSVReport_Recipient\SQL\SQL_OS%Pdate%%Currtime%\"
REM **** The following code - Copy the entire folders within "C:\TEMP\System_Repository" in network drive ****
XCOPY /E /I "C:\TEMP\System_Repository" "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\CSVReport_Recipient\SQL\SQL_OS%Pdate%%Currtime%\"

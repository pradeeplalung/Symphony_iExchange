...
md "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\TestResults\BX_TP08\ORACLE\PreTest\Recipient\ORA_%Pdate%%Currtime%\"
REM **** The following code - Copy the entire folders within "C:\TEMP\System_Repository" in network drive ****
XCOPY /E /I "C:\TEMP\System_Repository" "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\TestResults\BX_TP08\ORACLE\PreTest\Recipient\ORA_%Pdate%%Currtime%\"
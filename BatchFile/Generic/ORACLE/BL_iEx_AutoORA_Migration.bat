...
REM copy /V /Y "Z:\Symphony\Bluelight iExchange\Setup\Automation\*.exe" "C:\Automation\BL_iEx\AutomatedInstall\"
copy /V /Y "Z:\Symphony\Bluelight\Setup\Automation\Symphony Bluelight Oracle 5.5.*.exe" "C:\Automation\BL_iEx\AutomatedInstall\"
...
REM for %%A IN ("C:\Automation\BL_iEx\AutomatedInstall\Bluelight iExchange 5*.*") DO set Bluelight="%%A"
REM for %%B IN ("C:\Automation\BL_iEx\AutomatedInstall\Bluelight iExchange Manager*.*") DO set Manager="%%B"
for %%E IN ("C:\Automation\BL_iEx\AutomatedInstall\Symphony Bluelight Oracle*.*") DO set Oracle="%%E"
...
REM if errorlevel 1 echo (Part3) Manager failed to install, Not essential item >> %SymLog%

REM #### Attempt to run files ####
%Oracle% SILENT=TRUE 1  MIGRATION_SINGLE=TRUE MIGRATION_TYPE=0  INSTANCE_NAME="SYMPHONY" SCHEMA_NAME="BLUELIGHT_NAG_RECIP" SCHEMA_PASSWORD="BLUELIGHT_NAG_RECIP" SYSTEM_PASSWORD="SYSTEM" /l="C:\Automation\BL_iEx\AutomatedInstall\InstallLog\Oracle_Log.txt"

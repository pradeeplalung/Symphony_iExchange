...
copy /V /Y "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\BatchFile\Generic\ORACLE\AllBatch4BX_TP*_ORA.bat" "C:\Automation\BL_iEx\BatchFile\Generic\ORACLE\"
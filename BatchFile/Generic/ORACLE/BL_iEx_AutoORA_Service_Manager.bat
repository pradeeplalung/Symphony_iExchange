...
REM for %%E IN ("C:\Automation\BL_iEx\AutomatedInstall\Bluelight iExchange Oracle*.*") DO set Oracle="%%E"
...
REM #### Attempt to run files ####
REM %Oracle% SILENT=TRUE 1  SERVER_NAME="" DATABASE_NAME="" /l="C:\Automation\BL_iEx\AutomatedInstall\InstallLog\Oracle_Log.txt"
REM if errorlevel 1 goto FAIL_PART5
...
REM set InstLog="C:\Automation\BL_iEx\AutomatedInstall\InstallLog\InstallLogORA\Install_Successful_%Pdate%.log"

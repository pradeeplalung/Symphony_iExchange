...
copy /V /Y "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\BatchFile\BX_TP08\ORACLE\*.bat" "C:\Automation\BL_iEx\BatchFile\BX_TP08\ORACLE\"
copy /V /Y "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\BatchFile\BX_TP08\Generic\*.bat" "C:\Automation\BL_iEx\BatchFile\BX_TP08\Generic\"
...
copy /V /Y "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\BatchFile\Generic\SQL\AllBatch4BX_TP*_SQL.bat" "C:\Automation\BL_iEx\BatchFile\Generic\SQL\"
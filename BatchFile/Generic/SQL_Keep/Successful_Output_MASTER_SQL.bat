...
copy /V /Y "C:\Automation\BL_iEx\Database\BX_MASTERBASELINE_SQL_READY.xls" "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\Run_Completion_MASTER_SQL\"
...
copy /V /Y "Z:\Symphony\Gazetteer\Setup\Automation\Symphony Spatial SQL Server 5.4*.exe" "C:\Automation\Sym_iEx\AutomatedInstall\"
...
for %%D IN ("C:\Automation\Sym_iEx\AutomatedInstall\Symphony Spatial SQL Server*.*") DO set SQL="%%D"
...
REM #### Attempt to run files ####
%SQL% SILENT=TRUE 1  SERVER_NAME="PL-Win7Dual" DATABASE_NAME="TRAINING_1" /l="C:\Automation\Sym_iEx\AutomatedInstall\InstallLog\SQL_Log.txt"
...
set InstLog="C:\Automation\Sym_iEx\AutomatedInstall\InstallLog\InstallLogSQL\Install_Successful_%Pdate%.log"

...
copy /V /Y "Z:\SinglePoint\Setup\QTP_Build\SinglePoint 4.4*.exe" "C:\Automation\Sym_iEx\AutomatedInstall\"
...
for %%A IN ("C:\Automation\Sym_iEx\AutomatedInstall\SinglePoint 4.4*.*") DO set SinglePoint="%%A"
...
set InstLog="C:\Automation\Sym_iEx\AutomatedInstall\InstallLog\InstallLogSQLSinglePoint\Install_Successful_%Pdate%.log"

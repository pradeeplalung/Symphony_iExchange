...
md "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\TestResults\BX_TP11\ORACLE\T002\ImportReport\IR_%Pdate%%Currtime%\"

copy /V /Y "C:\Automation\BL_iEx\CSV\Import Files\LO_Report\SQL\*.*" "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\TestResults\BX_TP11\ORACLE\T002\ImportReport\IR_%Pdate%%Currtime%\"
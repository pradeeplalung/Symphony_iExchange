...
md "R:\Symphony iExchange\Testing\Automation\iManage\LLPG\TestResults\IX_TP11\SQL\T002\ImportReport\IR_%Pdate%%Currtime%\"

copy /V /Y "C:\Automation\Sym_iEx\CSV\Import Files\NLPG_Report\SQL\*.*" "R:\Symphony iExchange\Testing\Automation\iManage\LLPG\TestResults\IX_TP11\SQL\T002\ImportReport\IR_%Pdate%%Currtime%\"
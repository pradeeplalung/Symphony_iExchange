...
md "R:\Symphony iExchange\Testing\Automation\iManage\LLPG\TestResults\IX_TP10\ORACLE\PreTest\Recipient\ORA_%Pdate%%Currtime%\"
REM **** The following code - Copy the entire folders within "C:\TEMP\System_Repository" in network drive ****
XCOPY /E /I "C:\TEMP\System_Repository" "R:\Symphony iExchange\Testing\Automation\iManage\LLPG\TestResults\IX_TP10\ORACLE\PreTest\Recipient\ORA_%Pdate%%Currtime%\"
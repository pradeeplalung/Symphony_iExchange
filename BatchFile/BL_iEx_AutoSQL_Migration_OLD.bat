...
REM copy /V /Y "Z:\Symphony\Bluelight\Setup\Automation\Symphony Bluelight 5.4.1.0.exe" "C:\Bluelight\AutomatedInstall\"
REM copy /V /Y "Z:\Symphony\Bluelight\Setup\Automation\Symphony Bluelight SQL Server 5.5*.exe" "C:\Bluelight\AutomatedInstall\"
REM copy /V /Y "Z:\Symphony\Bluelight\Setup\Automation\Symphony Bluelight Address Exception Web Service 5.4.1.0.exe" "C:\Bluelight\AutomatedInstall\"
REM copy /V /Y "Z:\Symphony\Bluelight\Setup\Automation\Symphony Bluelight Import Service 5.4.1.0.exe" "C:\Bluelight\AutomatedInstall\"
REM copy /V /Y "Z:\SinglePoint\Setup\QTP_Build\SinglePoint 4.4.*.exe" "C:\Automation\SinglePoint\SP_Build\"
...
REM #### UNC drive unmapped successfully ####
Rem echo unmapped AAProducts drive  >> %SymLog%
...
Dim vMigrationCheck_ORA,vMigrationCheck_ORA
...
vSym_DB_Version1,vSym_DB_Build_Date,vAutoProcess_LogFile,vSym_iX_Ver_Paths,vCsvFile_ORA,vCsvFile_ORA

Dim vSym_IX_BldPath_Len,vSym_IX_Mng_BldPath_Len,vSym_BLD_BldPath_Len_ORA,vSym_BLD_BldPath_Len_ORA

Dim vTo,vCC,vSym_AllBlds_Folder,vAutoProcess_Log,vSym_IX_LogTxt_Path,vImportReportFiles_ORA,vImportReportFiles_ORA
...
Dim vInitializationVBScript_ORA,vInitializationVBScript_ORA,vReplaceScriptName_ORA,vReplaceScriptName_ORA

Dim vSym_Path_ReplaceScriptName_ORA,vSP_Path_ReplaceScriptName_ORA,vSPReplaceScriptName_ORA
...
Dim vSym_TP07_ORA,vSym_TP09_ORA,vSym_TP10_ORA,vSym_TP11_ORA,vSym_TP13_ORA,vSym_TP16_ORA,vSym_TP17_ORA,vSym_TP19_ORA' vSym_TP09_ReportSQL,vSym_TP09_ReportSQL,vSym_TP10_ReportSQL
...
'				@ Copy test plans, CSV files, xml file and batch file to QTP/UFT Machine
				Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\Generic\ORACLE\Updated_TestPlan_ORA.bat"
'				Wait(30)	
...
'					******
					...
					vCOUImportErrorFilesORA = Environment.Value("vCOUImportErrorFilesORA")
					print "vCOUImportErrorFilesORA  :"&vCOUImportErrorFilesORA
					...
					vLOImportErrorFilesORA = Environment.value("vLOImportErrorFilesORA")
					print "vLOImportErrorFilesORA  :"&vLOImportErrorFilesORA 
					
					vInitializationVBScript_ORA = Environment.Value("vInitializationVBScript_ORA")
					print " vInitializationVBScript_ORA  :"&vInitializationVBScript_ORA
					vInitializationVBScript_ORA = Environment.Value("vInitializationVBScript_ORA")
					vReplaceScriptName_ORA = Environment.Value("vReplaceScriptName_ORA")
					print "vReplaceScriptName_ORA  :"&vReplaceScriptName_ORA
										
					vSym_Path_ReplaceScriptName_ORA = Environment.Value("vSym_Path_ReplaceScriptName_ORA")
					print "vSym_Path_ReplaceScriptName_ORA  :"&vSym_Path_ReplaceScriptName_ORA
					
					vSP_Path_ReplaceScriptName_ORA = Environment.Value("vSP_Path_ReplaceScriptName_ORA")
...
'											       
											       print "Staring - Sym_TP07"
											       	vSym_TP07_ORA = Environment.Value("vSym_TP07_ORA")
'											       	vSym_TP07_ReportORA = Environment.Value("vSym_TP07_ReportORA")
'											       	print "vSym_TP07_ORA  :"&vSym_TP07_ORA
'											       	REM - fnPreTest_TP07_ORA vORA_Environment,vSym_TP07_ORA
											       	'Bring all generic updated batch files to QTP machine - Currently commentting out as need some validation
'											       	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\Generic\ORA\AllBatch4Sym_TP07_ORA.bat"
																										
													
																
														REM - fnSym_TP07_T002_ORA() ' No Bulk import , Not implemented as current csv is very old
														fnSym_TP07_T003_ORA() ' Bulk import
														
														fnReport_Sym_TP07_ORA
														print "Ending - Sym_TP07"
'														******************
												Case 4
														Rem @ Copy all the necessary Batch files from Network drive to QTP machine*****
														vSym_TP09_ORA = Environment.Value("vSym_TP09_ORA")
														print "vSym_TP09_ORA :"&vSym_TP09_ORA
'														REM - fnPreTest_TP09_ORA vORA_Environment,vSym_TP09_ORA
'														Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\Generic\ORA\AllBatch4Sym_TP09_ORA.bat"
														
														print "Sym_TP09"	
'														fnSym_TP09_T006_BN_ORA()' Skipping for time being
														fnSym_TP09_T006_ORA()
'														fnSym_TP09_T007_BN_ORA() ' Skipping for time being
														fnSym_TP09_T007_ORA()
																										
														fnReport_Sym_TP09_ORA
												Case 5
														Rem @ Copy all the necessary Batch files from Network drive to QTP machine*****
														vSym_TP10_ORA = Environment.Value("vSym_TP10_ORA")
														REM - fnPreTest_TP10_ORA vORA_Environment,vSym_TP10_ORA
'														Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\Generic\ORA\AllBatch4Sym_TP10_ORA.bat"
														
														print "Sym_TP10"
														fnSym_TP10_PreTest_ORA()
											
														fnReport_Sym_TP10_PreTest_ORA														
												Case 6	
														
														print "Sym_TP11"		
														Rem @ Copy all the necessary Batch files from Network drive to QTP machine*****
														vSym_TP11_ORA = Environment.Value("vSym_TP11_ORA")
														REM - fnPreTest_TP11_ORA vORA_Environment,vSym_TP11_ORA
'														Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\Generic\ORA\AllBatch4Sym_TP11_ORA.bat"
														print "Sym_TP11"
														fnSym_TP11_T001_ORA
														fnSym_TP11_T002_ORA
														fnSym_TP11_T003_ORA	
														
														fnReport_Sym_TP11_ORA																											
...
'									**************************
	...
	If fnReadFromExcel(vTP_Path,vTPC,k,6) = "No" Then
		...
		Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\Generic\ORACLE\IX_TestPlan_Update2Yes_ORA.bat"
		wait(5)
				' The following batch will copy and paste the test plan in 
		' "R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\Run_Completion_ORA "as an input for powershell script to do next task
		' It will also update the orginal Test plan i
		' R:\Symphony Bluelight iExchange\Testing\Automation\AddressBase\TestPlan_ORA so that next Test Plan will run based on
		...
		SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\Generic\ORACLE\Successful_Output_ORA.bat"
		Exit do
	End If
Loop
...
'Print "vInitializationVBScript_ORA  :"&vInitializationVBScript_ORA
'print "vSym_Path_ReplaceScriptName_ORA :"&vSym_Path_ReplaceScriptName_ORA
'Print "vSP_Path_ReplaceScriptName_ORA  :"&vSP_Path_ReplaceScriptName_ORA
fnReplaceLineWithSpecificValue vInitializationVBScript_ORA,vSym_Path_ReplaceScriptName_ORA,vSP_Path_ReplaceScriptName_ORA,vInitializationVBScript_ORA

'*************** Start PreTest****
Function fnPreTest_TP07_ORA(vORA_Environment,vPreTest_Bat_Recipient)
	
Print "Enter - PreTest after Environment is YES"
		If vORA_Environment  = "Yes" then
...
'											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\SaveEventLogApplication_ORA.bat"
...
'											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\Sym_TP07_COU_Recipient_ORA_PreTest.bat"
											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07\ORACLE\IX_TP07_COU_Recipient_ORA_PreTest.bat"
		...
		End If
End Function
Function fnPreTest_TP09_ORA(vORA_Environment,vPreTest_Bat_Recipient)
	
Print "Enter - PreTest after Environment is YES - fnPreTest_TP09_ORA"
		If vORA_Environment  = "Yes" then
					    Print "Starting PreTest after Environment is YES"
						Rem - Clear the Event Viewer list ******
						Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\ClearEventViewerListApplication.bat"
...
'											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07_COU_Recipient_ORA_PreTest.bat"
											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP09\ORA\IX_TP09_LO_Recipient_ORA_PreTest.bat"
											REM **************** 3. Clear the Event Viewer list ******
											Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\ClearEventViewerListSystem.bat"
											Print "1. Clear the event view list ****"
											Print "2. Stop the service"
		...
		End If
End Function
Function fnPreTest_TP10_ORA(vORA_Environment,vPreTest_Bat_Recipient)
	
Print "Enter - PreTest after Environment is YES - fnPreTest_TP10_ORA"
		If vORA_Environment  = "Yes" then
					    Print "Starting PreTest after Environment is YES"
						Rem - Clear the Event Viewer list ******
						Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\ClearEventViewerListApplication.bat"
...
'											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\SaveEventLogApplication_ORA.bat"
						'					*********  Save the PreTest Recipient files in R:Drive ***************
'											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07_COU_Recipient_ORA_PreTest.bat"
											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP10\ORACLE\IX_TP10_LO_Recipient_ORA_PreTest.bat"
											REM **************** 3. Clear the Event Viewer list ******
											Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\ClearEventViewerListSystem.bat"
											Print "1. Clear the event view list ****"
											Print "2. Stop the service"
...
End Function
'************
Function fnPreTest_TP11_ORA(vSQL_Environment,vPreTest_Bat_Recipient)
	
Print "Enter - PreTest after Environment is YES - fnPreTest_TP11_ORA"
...
'											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\SaveEventLogApplication_ORA.bat"
						'					*********  Save the PreTest Recipient files in R:Drive ***************
'											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07_COU_Recipient_ORA_PreTest.bat"
											SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP11\ORACLE\IX_TP11_LO_Recipient_ORA_PreTest.bat"
											REM **************** 3. Clear the Event Viewer list ******
											Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\ClearEventViewerListSystem.bat"
											Print "1. Clear the event view list ****"
											Print "2. Stop the service"
...
'********************************************************************************End of Sym_TP07 ******************
		...
		'*************	STEP 10 Reporting *************		
Function fnReport_Sym_TP07_ORA()	
		...
		'************ Send the above information via email to respective recipients/Stakeholders in the Test Plan
		 fnSend_TestResult_Sym_TP07_ORA vTo,vCC,vTestEnvironment_ORA,vExecutionTime,vSym_iX_Version1,vSym_iX_Service_Date,vSym_iX_Manager_Version1,_
		vSym_iX_Manager_Date,vSym_DB_Version1,vSym_DB_Build_Date,vMigrationCheck_ORA,vCsvFile_ORA,vImportReportFiles_ORA
		
End Function
Function fnReport_Sym_TP09_ORA()	
		...
		vExecutionTime = fnExecutionTime(vTimeTaken)
		'************ Send the above information via email to respective recipients/Stakeholders in the Test Plan
		 fnSend_TestResult_Sym_TP09_ORA vTo,vCC,vTestEnvironment_ORA,vExecutionTime,vSym_iX_Version1,vSym_iX_Service_Date,vSym_iX_Manager_Version1,_
		 vSym_iX_Manager_Date,vSym_DB_Version1,vSym_DB_Build_Date,vMigrationCheck_ORA,vCsvFile_ORA,vImportReportFiles_ORA
		
End Function
Function fnReport_Sym_TP10_PreTest_ORA()	
		...
		vExecutionTime = fnExecutionTime(vTimeTaken)
		'************ Send the above information via email to respective recipients/Stakeholders in the Test Plan
		fnSend_TestResult_Sym_TP10_ORA vTo,vCC,vTestEnvironment_ORA,vExecutionTime,vSym_iX_Version1,vSym_iX_Service_Date,vSym_iX_Manager_Version1,_
		 vSym_iX_Manager_Date,vSym_DB_Version1,vSym_DB_Build_Date,vMigrationCheck_ORA,vCsvFile_ORA,vImportReportFiles_ORA
		 
		
End Function
'**************
Function fnReport_Sym_TP11_ORA()	
		...
		vExecutionTime = fnExecutionTime(vTimeTaken)
		'************ Send the above information via email to respective recipients/Stakeholders in the Test Plan
		 fnSend_TestResult_Sym_TP11_ORA vTo,vCC,vTestEnvironment_ORA,vExecutionTime,vSym_iX_Version1,vSym_iX_Service_Date,vSym_iX_Manager_Version1,_
		 vSym_iX_Manager_Date,vSym_DB_Version1,vSym_DB_Build_Date,vMigrationCheck_ORA,vCsvFile_ORA,vImportReportFiles_ORA	 		 
...
Function fnSym_TP07_T002_ORA() ' No Bulk Import
											...
											Print "Copy all the import report into network Drive_CopyImportReportSym_TP07_T002_ORA"
											fnCopyImportReportSym_TP07_T002_ORA()
											wait(5)
		...
		'										************
										...
										'					fnStopService vServiceName,vComputerName
															...
															If vStoppedSuccessfully = True Then
																	...
																	SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07\ORACLE\IX_TP07_T002_COU_Recipient_ORA.bat"
''																	
															End If
														End If
...
End Function
Function fnSym_TP07_T003_ORA() ' Bulk import
											...
											Print "Import process successfully completed"
											REM - Copy all the import report into network Drive 
											Print "Copy all the import report into network Drive_CopyImportReportSym_TP07_T003_ORA"
											fnCopyImportReportSym_TP07_T003_ORA()											
											wait(5)
											Print "Delete all the import report,COU csv files and combined folder"
		...
		'										************
										...
										'					fnStopService vServiceName,vComputerName
															...
															If vStoppedSuccessfully = True Then
																	Print "Copying the recipient folder to network drive SQL"
																	Rem ### Copying recipient files in R:Drive
																	SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07\ORACLE\IX_TP07_T003_COU_Recipient_ORA.bat"
'		
															End If
														End If
...
End Function
Function fnSym_TP09_T006_ORA() ' No Bulk update
											...
											Print "Import process successfully completed"
											REM - Copy all the import report into network Drive 
											Print "Copy all the import report into network Drive_CopyImportReportSym_TP09_T002_ORA"
											fnCopyImportReportSym_TP09_T006_ORA()
											wait(5)
'											fnDeleteFileFolderSQL
		...
		'										************
										...
										'					fnStopService vServiceName,vComputerName
															...
															If vStoppedSuccessfully = True Then
																	Print "Copying the recipient folder to network drive SQL"
																	Rem ### Copying recipient files in R:Drive
																	SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP09\ORACLE\IX_TP09_T006_COU_Recipient_ORA.bat"
''						
															End If
														End If
...
Function fnSym_TP09_T007_ORA() ' No Bulk update
											...
											REM - Copy all the import report into network Drive 
											Print "Copy all the import report into network Drive_CopyImportReportSym_TP09_T002_ORA"
											fnCopyImportReportSym_TP09_T007_ORA()
											wait(5)
											fnDeleteFileFolderSQL
		...
		'										************
										...
										'					fnStopService vServiceName,vComputerName
															...
															If vStoppedSuccessfully = True Then
																	Print "Copying the recipient folder to network drive SQL"
																	Rem ### Copying recipient files in R:Drive
																	SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP09\ORACLE\IX_TP09_T007_COU_Recipient_ORA.bat"
''						
															End If
														End If
...
Function fnSym_TP10_PreTest_ORA() ' No Bulk update
											print "Sym_TP10_PreTest_ORA Starting"
											Print "Delete all the import report,LO csv files and combined folder from previous ImportT001"
											fnDeleteFileFolderSQL
											...
											REM - Copy all the import report into network Drive 
											Print "Copy all the import report into network Drive_CopyImportReportSym_TP09_T002_ORA"
											fnCopyImportReportSym_TP10_PreTest_ORA()
											wait(5)
											fnDeleteFileFolderSQL
...
Function fnSym_TP11_T001_ORA()
								...
								Print "Import process successfully completed"
								REM - Copy all the import report into network Drive 
								Print "Copy all the import report into network Drive_CopyImportReportSym_TP11_T001_ORA"
								fnCopyImportReportSym_TP11_T001_ORA()
								wait(5)
...
'										************
							...
							'					fnStopService vServiceName,vComputerName
												...
												If vStoppedSuccessfully = True Then
														Print "Copying the recipient folder to network drive SQL"
														Rem ### Copying recipient files in R:Drive
														SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP11\ORACLE\IX_TP11_T001_COU_Recipient_ORA.bat"
...
Function fnSym_TP11_T002_ORA()
								...
								Print "Import process successfully completed"
								REM - Copy all the import report into network Drive 
								Print "Copy all the import report into network Drive_CopyImportReportSym_TP12_T002_ORA"
								fnCopyImportReportSym_TP11_T002_ORA()
								wait(5)
								Print "Delete all the import report,LO csv files and combined folder"
								fnDeleteFileFolderSQL
...
'										************
							...
							'					fnStopService vServiceName,vComputerName
												...
												If vStoppedSuccessfully = True Then
														Print "Copying the recipient folder to network drive SQL"
														Rem ### Copying recipient files in R:Drive
														SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP11\ORACLE\IX_TP11_T002_COU_Recipient_ORA.bat"
''																	SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\Successful_Output_ORA.bat"
												End If
											End If
...
Function fnSym_TP11_T003_ORA()
								...
								Print "Import process successfully completed"
								REM - Copy all the import report into network Drive 
								Print "Copy all the import report into network Drive_CopyImportReportSym_TP12_T003_ORA"
								fnCopyImportReportSym_TP11_T003_ORA()
								wait(5)
								Print "Delete all the import report,LO csv files and combined folder"
								fnDeleteFileFolderSQL								
...
'										************
							...
							'					fnStopService vServiceName,vComputerName
												...
												If vStoppedSuccessfully = True Then
														Print "Copying the recipient folder to network drive SQL"
														Rem ### Copying recipient files in R:Drive
														SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP11\ORACLE\IX_TP11_T003_COU_Recipient_ORA.bat"
''																	SystemUtil.Run "C:\Automation\Sym_iEx\BatchFile\Successful_Output_ORA.bat"
												End If
											End If
...
Function fnCopyImportReportSym_TP07_T002_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07\ORACLE\IX_TP07_T002_COU_ImportReport_ORA.bat"
End Function
Function fnCopyImportReportSym_TP07_T003_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07\ORACLE\IX_TP07_T003_COU_ImportReport_ORA.bat"
End Function
Function fnCopyImportReportSym_TP07_T004_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP07\ORACLE\IX_TP07_T004_COU_ImportReport_ORA.bat"
End Function


'****************  Sym_TP09 Copying importReport to R:Drive  **********

Function fnCopyImportReportSym_TP09_T006_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP09\ORACLE\IX_TP09_T006_COU_ImportReport_ORA.bat"
End Function
Function fnCopyImportReportSym_TP09_T007_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP09\ORACLE\IX_TP09_T007_COU_ImportReport_ORA.bat"
End Function


'**********************************
'****************  Sym_TP10 Copying importReport to R:Drive  **********
Function fnCopyImportReportSym_TP10_PreTest_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP10\ORACLE\IX_TP10_PreTest_COU_ImportReport_ORA.bat"
End Function

'*************Sym_TP11 Copying importReport to R:Drive********
Function fnCopyImportReportSym_TP11_T001_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP11\ORACLE\IX_TP11_T001_COU_ImportReport_ORA.bat"
End Function
Function fnCopyImportReportSym_TP11_T002_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP11\ORACLE\IX_TP11_T002_COU_ImportReport_ORA.bat"
End Function
Function fnCopyImportReportSym_TP11_T003_ORA()
	Systemutil.Run "C:\Automation\Sym_iEx\BatchFile\IX_TP11\ORACLE\IX_TP11_T003_COU_ImportReport_ORA.bat"
End Function

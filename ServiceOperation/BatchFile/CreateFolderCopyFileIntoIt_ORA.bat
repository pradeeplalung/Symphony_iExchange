...
md "Z:\Symphony\Bluelight iExchange\Automation\AddressBase\CSVReport_Recipient\ORA\ORA_OS%Pdate%%Currtime%\"
REM **** The following code - Copy the entire folders within "C:\TEMP\System_Repository" in network drive ****
XCOPY /E /I "C:\TEMP\System_Repository" "Z:\Symphony\Bluelight iExchange\Automation\AddressBase\CSVReport_Recipient\ORA\ORA_OS%Pdate%%Currtime%\"

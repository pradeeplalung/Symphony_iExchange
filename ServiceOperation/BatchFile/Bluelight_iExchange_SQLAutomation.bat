...
for %%D IN ("C:\Automation\BL_iEx\AutomatedInstall\Bluelight iExchange SQL*.*") DO set SQL="%%D"
...
REM #### Attempt to run files ####
%SQL% SILENT=TRUE 1  SERVER_NAME="" DATABASE_NAME="" /l="C:\Automation\BL_iEx\AutomatedInstall\InstallLog\SQL_Log.txt"

...
Dim vMigrationCheck_ORA,vMigrationCheck_SQL,vIM_DBMigration_SQL
...
Dim vSP_Build,vSP_Ver_Paths,vSP_Build_Date,vSP_Build1,vSP_Version,vSP_Version1
...
If vIM_DBMigration_SQL = "No" or (vIM_DBMigration_SQL = "Yes" and fnIM_DBMigration_SQL = True) Then
	'fnIX_DBMigrationIns_SQL
	systemutil.Run "C:\Automation\Sym_iEx\BatchFile\Generic\Sym_iEx_AccSet.bat" ' Seting service account
End If
''
If fnIX_DBMigrationIns_SQL = True Then
	fnSinglePointInstallation()
End If


'********************* STEP 6 - Reporting *************************************
If fnSinglePointInstallation =True Then
	fnReport_SQL
End If
...
'				*******************
				...
				vSym_IXDb_Ver1,vSym_iX_DB_Date
End Function
...
''Dim vCC:vCC = "pradeep.lalung@ymail.com"
''Dim vTestEnvironment_ORA:vTestEnvironment_ORA = "ORA"
''fnSendReportOnMASTERBaseLineCreation vTo,vCC,vTestEnvironment_SQL,vExecutionTime,vSym_iX_Version1,vSym_iX_Service_Date,vSym_iX_Manager_Version1,_
''vSym_iX_Manager_Date,vSym_DB_Version1,vSym_DB_Build_Date,vMigrationCheck_SQL,vCsvFile_SQL,vImportReportFiles_SQL,vSP_Build_Date,vSP_Version1,_
''vSym_IXDb_Ver1,vSym_iX_DB_DatertReportFiles_ORA
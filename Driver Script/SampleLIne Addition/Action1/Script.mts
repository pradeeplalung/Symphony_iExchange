...
search = "<entry name="&chr(34)&"Report Folder"&chr(34)&">\\PL-WIN7DUAL\Symphony_Report</entry>"
print search
FilePath = "C:\SSF\BLUELIGHT_NAG_RECIP_SQL.SSF"
...
contents = textFile.ReadAll
  ...
  print contents 
  print "***************"
  Dim aSects : aSects = Split(contents , search)

...
Function fnT001(vRowControl,vReplaceImportFolderLine)
					 fnBluelightSettingToORACLE(vSym_App_Setting_Path)
...
Function fnT002(vRowControl,vReplaceImportFolderLine)
					fnBluelightSettingToSQL(vSym_App_Setting_Path)
...
End Function
''''*****************************
Function fnBluelightSettingToSQL(vSym_App_Setting_Path)
...
End Function
'*************
Function fnBluelightSettingToORACLE(vSym_App_Setting_Path)
					SystemUtil.Run vSym_App_Setting_Path		'''*********************************       
					Wait(10)  
